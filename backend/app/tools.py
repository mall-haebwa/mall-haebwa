...
SHOPPING_TOOLS = [
    ...
    },
    {
        "toolSpec": {
            ...
            "description": """여러 상품을 동시에 검색합니다. 다음 경우 반드시 이 Tool을 사용하세요:
- 요리/음식 재료 요청 (예: '김치찌개 재료', '파스타 재료', '라면 끓이기', '된장찌개 끓이기')
- 쉼표로 구분된 복수 상품 (예: '감자, 고구마, 양파 찾아줘')
- '준비물', '필요한 것들', '재료', '만들기' 키워드 포함된 요청
- 밀키트 + 개별 재료 옵션을 함께 제공해야 할 때

자동으로 밀키트 상품(있는 경우)과 개별 재료 옵션(김치, 돼지고기, 두부 등)을 함께 제공합니다.""",
            "inputSchema": {
                "json": {
                    "type": "object",
                    "properties": {
